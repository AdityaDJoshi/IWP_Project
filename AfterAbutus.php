...
<body>
    ...
    <img class="a" src="https://news.gtp.gr/wp-content/uploads/2018/11/World-Luxury-Awards-logo.jpg" width="15%" alt=""
        style="object-fit: cover;">
    <img class="b"
        src="https://images.squarespace-cdn.com/content/v1/592c1a183e00be0c6ceb3dcb/1593510784782-7B6T1UGAD179E5QDWRDT/2019+World+Luxury+Hotel+Awards.jpg?format=500w"
        alt="" width="15%">
    <img class="c" src="https://thedynastyvillas.com/wp-content/uploads/2020/10/2020-Hotel-Awards-Winner-logo.jpg"
        alt="" width="15%">
                    ...
                    <div class="owl-carousel test-slides" id="testimonial-carousel">
                        <div class="item">
                            <div class="single-testimonial">
                                <div class="img-area"><img class="card-img-top"
                        ...
                        <div class="item">
                            <div class="single-testimonial">
                                <div class="img-area"><img class="card-img-top"
                                        src="https://images.pexels.com/photos/1861594/pexels-photo-1861594.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=650&w=940"
                                        alt="">
                                </div>
                                <div class="testi-text">
                        ...
                        <div class="item">
                            <div class="single-testimonial">
                                <div class="img-area"><img class="card-img-top"
                                        src="https://images.unsplash.com/photo-1549836938-d278c5d46d20?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=303&ixid=eyJhcHBfaWQiOjF9&ixlib=rb-1.2.1&q=50&w=301"
                                        alt="">
                                </div>
                                <div class="testi-text">
                        ...
                        <div class="item">
                            <div class="single-testimonial">
                                <div class="img-area"><img class="card-img-top"
                                        src="https://images.unsplash.com/photo-1588361035994-295e21daa761?crop=entropy&cs=tinysrgb&fit=crop&fm=jpg&h=301&ixid=eyJhcHBfaWQiOjF9&ixlib=rb-1.2.1&q=50&w=304"
                                        alt="">
                                </div>
                                <div class="testi-text">
                                    <h4>Erika Johnson<span>Web Developer</span></h4>
